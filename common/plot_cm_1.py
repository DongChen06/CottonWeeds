...
conf_mat0 = np.genfromtxt('mnasnet1_0_cm_0.csv', delimiter=',')[1:, 1:]

conf_mat1 = np.genfromtxt('mnasnet1_0_cm_1.csv', delimiter=',')[1:, 1:]

conf_mat2 = np.genfromtxt('mnasnet1_0_cm_2.csv', delimiter=',')[1:, 1:]

conf_mat3 = np.genfromtxt('mnasnet1_0_cm_3.csv', delimiter=',')[1:, 1:]

conf_mat4 = np.genfromtxt('mnasnet1_0_cm_4.csv', delimiter=',')[1:, 1:]
