...
class_names = ['Carpetweeds', 'Crabgrass', 'Goosegrass', 'Morningglory', 'Nutsedge', 'PalmerAmaranth',
...
def main():
    ...
    parser.add_argument('-source', action='store', type=str, default=r'C:\Users\Windows\Downloads\toy\Swinecress', help='directory of the source images')
    parser.add_argument('-d', '--delimiter', required=False, type=str, default=',',
                        help="delimiter to the output file, default: ','")
    parser.add_argument('-o', '--out-path', required=False, type=str,
                        help='path to the output file, default: name of the source directory')
